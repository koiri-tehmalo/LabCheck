    ...
    <div className="flex flex-col gap-4 md:gap-8">
       <Card className="glass-card border-border/40">
        <CardHeader>
          ...
          <CardDescription>แก้ไขข้อมูลครุภัณฑ์หมายเลข <span className="font-mono bg-[hsl(230,80%,62%,0.15)] text-[hsl(230,80%,70%)] px-1.5 py-0.5 rounded">{item.assetId}</span></CardDescription>
        </CardHeader>
        <CardContent>
